...
class TextEncoder(nn.Module):
    ...
    def __init__(self, config):
        ...
        if self.encoder_type == "bert":
            self.text_model = BertModel.from_pretrained(model_source, **load_kwargs)
            print(f"Loading BERT model from: {model_source}")
        elif self.encoder_type == "roberta":
            self.text_model = RobertaModel.from_pretrained(model_source, **load_kwargs)
            print(f"Loading RoBERTa model from: {model_source}")
        else:
